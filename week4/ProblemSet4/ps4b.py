...
def playGame(wordList):
    ...
    state = True
    while state:
        userInput1 = str(raw_input("Enter n to deal a new hand, r to replay the last hand, or e to end game: "))
        if userInput1 == "n":
            hand = dealHand(HAND_SIZE)
            userInput2 = str(raw_input("Enter u to have yourself play, c to have the computer play: "))
            if userInput2 == "c":
                compPlayHand(hand, wordList, HAND_SIZE)
            elif userInput2 == "u":
                playHand(hand, wordList, HAND_SIZE)
            else:
                while userInput2 != "c" or userInput2 !="u":
